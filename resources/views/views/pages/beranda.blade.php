...
<!-- ========================================== -->
<!-- POINT 3: TOMBOL INSTALL PWA & SCRIPTNYA -->
<!-- ========================================== -->
<button id="installApp" class="fixed bottom-6 right-6 z-50 hidden items-center gap-2 bg-primary text-on-primary px-6 py-3 rounded-full font-label-md text-label-md shadow-lg hover:bg-primary-container hover:text-on-primary-container transition-all active:scale-95 duration-200">
...
<script>
    ...
    window.addEventListener('beforeinstallprompt', (e) => {
        ...
        deferredPrompt = e;
        // Tampilkan tombol install (hapus class hidden, tambah flex dari tailwind)
